...
exports.getParentProfile = async (req, res) => {
  try {
    ...
    console.log("Starting getParentInfo for student:", req.query.studentId);
    ...
    // Get the profile collection from the right database
    const profileCollection = getParentProfileCollection();
