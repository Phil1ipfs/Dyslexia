    ...
    configureServer(server) {
      server.middlewares.use((req, res, next) => {
        ...
        const csp = [
          ...
          "media-src 'self' blob:",
          "connect-src 'self' http://localhost:5001 http://18.139.217.179:5001 https://18.139.217.179:5001 https://api.literexia.com https://*.sentry.io https://*.ingest.us.sentry.io https://o4510122170646528.ingest.us.sentry.io ws://localhost:5173 wss://localhost:5173",
          "object-src 'none'",
