  ...
  return (
    <div className="teacher-dashboard">
      ...
      <main className="teacher-dashboard__content">
        ...
        {/* Grade 1 Prescriptive Analysis Section */}
        <div className="teacher-dashboard__full-width">
          <div className="teacher-prescriptive-analysis-section">
            <div className="teacher-prescriptive-header">
              <h2 className="teacher-prescriptive-title">
                <span className="teacher-prescriptive-icon">📊</span>
                Grade 1 Prescriptive Analysis - Project Cornerstone
              </h2>
              <p className="teacher-prescriptive-subtitle">
                Advanced analytics using Bayesian Knowledge Tracing (BKT) and Item Response Theory (IRT) models
              </p>
            </div>

            {/* Overview Cards */}
            <div className="teacher-prescriptive-overview">
              <div className="teacher-prescriptive-overview-card">
                <div className="teacher-prescriptive-card-icon" style={{ backgroundColor: '#3B4F81' }}>
                  <span>🎯</span>
                </div>
                <div className="teacher-prescriptive-card-content">
                  <h3>Overall Performance</h3>
                  <div className="teacher-prescriptive-metric">
                    <span className="teacher-prescriptive-metric-value">78%</span>
                    <span className="teacher-prescriptive-metric-label">Average Mastery</span>
                  </div>
                </div>
              </div>
              ...
              <div className="teacher-prescriptive-overview-card">
                ...
                <div className="teacher-prescriptive-card-content">
                  ...
                  <div className="teacher-prescriptive-metric">
                    <span className="teacher-prescriptive-metric-value">+15%</span>
                    <span className="teacher-prescriptive-metric-label">Improvement Rate</span>
                  </div>
                </div>
              </div>
              ...
              <div className="teacher-prescriptive-overview-card">
                ...
                <div className="teacher-prescriptive-card-content">
                  ...
                  <div className="teacher-prescriptive-metric">
                    <span className="teacher-prescriptive-metric-value">85%</span>
                    <span className="teacher-prescriptive-metric-label">Success Rate</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="teacher-prescriptive-categories">
              <h3 className="teacher-prescriptive-categories-title">Category-Specific Analysis (BKT & IRT Models)</h3>
              <div className="teacher-prescriptive-categories-grid">
                
                {/* Alphabet Knowledge Card */}
                <div className="teacher-prescriptive-category-card-detailed">
                  <div className="teacher-prescriptive-category-header">
                    <div className="teacher-prescriptive-category-icon" style={{ backgroundColor: '#4BC0C0' }}>
                      <span>👤</span>
                    </div>
                    <h4>Alphabet Knowledge</h4>
                    <span className="teacher-prescriptive-status-badge teacher-prescriptive-status-critical">Critical</span>
                  </div>
                  
                  <div className="teacher-prescriptive-category-metrics">
                    <div className="teacher-prescriptive-metric-item">
                      <span className="teacher-prescriptive-metric-label">Students:</span>
                      <span className="teacher-prescriptive-metric-value">2</span>
                    </div>
                    <div className="teacher-prescriptive-metric-item">
                      <span className="teacher-prescriptive-metric-label">Accuracy:</span>
                      <span className="teacher-prescriptive-metric-value teacher-prescriptive-metric-critical">39.6%</span>
                    </div>
                    <div className="teacher-prescriptive-metric-item">
                      <span className="teacher-prescriptive-metric-label">BKT Mastery:</span>
                      <span className="teacher-prescriptive-metric-value">12%</span>
                    </div>
                    <div className="teacher-prescriptive-metric-item">
                      <span className="teacher-prescriptive-metric-label">IRT Ability:</span>
                      <span className="teacher-prescriptive-metric-value teacher-prescriptive-metric-warning">-1.4</span>
                    </div>
                  </div>

                  <div className="teacher-prescriptive-analysis-details">
                    <div className="teacher-prescriptive-strengths">
                      <h5>Strengths</h5>
                      <ul>
                        <li>Fast, confident responding (8.9s average) shows skill automaticity</li>
                        <li>Students have internalized concepts well and can apply them efficiently</li>
                        <li>Robust data sample (91 responses) provides reliable performance insights</li>
                        <li>Comprehensive assessment data enables confident instructional decisions</li>
                      </ul>
                    </div>
                    <div className="teacher-prescriptive-weaknesses">
                      <h5>Weaknesses</h5>
                      <ul>
                        <li>Critical performance deficiency at 39.6% accuracy - immediate intensive intervention required</li>
                      </ul>
                    </div>
                  </div>
                </div>

                {/* Phonological Awareness Card */}
                <div className="teacher-prescriptive-category-card-detailed">
                  <div className="teacher-prescriptive-category-header">
                    <div className="teacher-prescriptive-category-icon" style={{ backgroundColor: '#FF9F40' }}>
                      <span>👤</span>
                    </div>
                  ...
                  <div className="teacher-prescriptive-category-metrics">
                    <div className="teacher-prescriptive-metric-item">
                      <span className="teacher-prescriptive-metric-label">Students:</span>
                      <span className="teacher-prescriptive-metric-value">1</span>
                    </div>
                    <div className="teacher-prescriptive-metric-item">
                      <span className="teacher-prescriptive-metric-label">Accuracy:</span>
                      <span className="teacher-prescriptive-metric-value teacher-prescriptive-metric-critical">28%</span>
                    </div>
                    <div className="teacher-prescriptive-metric-item">
                      <span className="teacher-prescriptive-metric-label">BKT Mastery:</span>
                      <span className="teacher-prescriptive-metric-value">12%</span>
                    ...
                    <div className="teacher-prescriptive-metric-item">
                      <span className="teacher-prescriptive-metric-label">IRT Ability:</span>
                      <span className="teacher-prescriptive-metric-value teacher-prescriptive-metric-positive">+0.19</span>
                    </div>
                  </div>
                  ...
                  <div className="teacher-prescriptive-analysis-details">
                    <div className="teacher-prescriptive-strengths">
                      <h5>Strengths</h5>
                      <ul>
                        <li>Baseline performance data collected successfully</li>
                        <li>Foundation established for tracking improvement over time</li>
                        <li>Assessment system is functioning properly to identify student needs</li>
                      </ul>
                    </div>
                    <div className="teacher-prescriptive-weaknesses">
                      <h5>Weaknesses</h5>
                      <ul>
                        <li>Critical performance deficiency at 28% accuracy - immediate intensive intervention required</li>
                        <li>Students are not accessing grade-level content effectively - significant achievement gap developing</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="teacher-prescriptive-category-card-detailed">
                  <div className="teacher-prescriptive-category-header">
                    <div className="teacher-prescriptive-category-icon" style={{ backgroundColor: '#FF6B6B' }}>
                      <span>👤</span>
                    </div>
                    <h4>Decoding</h4>
                    <span className="teacher-prescriptive-status-badge teacher-prescriptive-status-struggling">Struggling</span>
                  </div>
                  ...
                  <div className="teacher-prescriptive-category-metrics">
                    ...
                    <div className="teacher-prescriptive-metric-item">
                      <span className="teacher-prescriptive-metric-label">Accuracy:</span>
                      <span className="teacher-prescriptive-metric-value teacher-prescriptive-metric-critical">40%</span>
                    </div>
                    <div className="teacher-prescriptive-metric-item">
                      <span className="teacher-prescriptive-metric-label">BKT Mastery:</span>
                      <span className="teacher-prescriptive-metric-value">12%</span>
                    ...
                    <div className="teacher-prescriptive-metric-item">
                      <span className="teacher-prescriptive-metric-label">IRT Ability:</span>
                      <span className="teacher-prescriptive-metric-value teacher-prescriptive-metric-warning">-0.41</span>
                    </div>
                  </div>
                  ...
                  <div className="teacher-prescriptive-analysis-details">
                    <div className="teacher-prescriptive-strengths">
                      <h5>Strengths</h5>
                      <ul>
                        <li>Reasonable response times indicate thoughtful processing without hesitation</li>
                        <li>Good balance between speed and accuracy - students are developing fluency</li>
                      </ul>
                    </div>
                    <div className="teacher-prescriptive-weaknesses">
                      <h5>Weaknesses</h5>
                      <ul>
                        <li>Severe below-grade-level performance at 40% accuracy - comprehensive intervention needed</li>
                        <li>Students missing foundational skills required for reading progression - systematic skill building required</li>
                        <li>Achievement gap widening - coordinate with reading specialists and consider IEP evaluations</li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            {/* Key Insights */}
            <div className="teacher-prescriptive-insights">
              <h3 className="teacher-prescriptive-insights-title">Key Insights & Recommendations</h3>
              <div className="teacher-prescriptive-insights-grid">
                <div className="teacher-prescriptive-insight-card">
                  <div className="teacher-prescriptive-insight-icon" style={{ backgroundColor: '#3B4F81' }}>
                    <span>💡</span>
                  </div>
                  <div className="teacher-prescriptive-insight-content">
                    <h4>Strengths Identified</h4>
                    <ul>
                      <li>Strong Word Recognition skills (91% mastery)</li>
                      <li>Good Phonological Awareness foundation</li>
                      <li>Consistent improvement in Reading Comprehension</li>
                    </ul>
                  </div>
                </div>

                <div className="teacher-prescriptive-insight-card">
                  <div className="teacher-prescriptive-insight-icon" style={{ backgroundColor: '#FF6B6B' }}>
                    <span>⚠️</span>
                  </div>
                  <div className="teacher-prescriptive-insight-content">
                    <h4>Areas for Improvement</h4>
                    <ul>
                      <li>Alphabet Knowledge needs targeted intervention</li>
                      <li>Decoding skills require additional practice</li>
                      <li>Response time optimization needed</li>
                    </ul>
                  </div>
                </div>

                <div className="teacher-prescriptive-insight-card">
                  <div className="teacher-prescriptive-insight-icon" style={{ backgroundColor: '#4BC0C0' }}>
                    <span>🎯</span>
                  </div>
                  <div className="teacher-prescriptive-insight-content">
                    <h4>Recommended Actions</h4>
                    <ul>
                      <li>Implement multisensory alphabet instruction</li>
                      <li>Increase phonics-based decoding practice</li>
                      <li>Use visual aids for complex word recognition</li>
                    </ul>
                  </div>
                </div>
              </div>
