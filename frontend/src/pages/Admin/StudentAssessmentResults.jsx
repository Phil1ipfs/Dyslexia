                                      ...
                                      {response.questionDetails.sentenceQuestions && response.questionDetails.sentenceQuestions.length > 0 && (
                                        <div>
                                          ...
                                          {response.questionDetails.sentenceQuestions.map((sq, sqIndex) => {
                                              ...
                                              // Get student's answer for this sentence question
                                              const studentAnswer = Array.isArray(response.response) && response.response[sqIndex]
                                                ? String(response.response[sqIndex]).trim()
                                                : '';

                                              // Check if student's answer is correct
                                              const isStudentAnswerCorrect = studentAnswer && (
                                                  ...
                                                  {studentAnswer && (
                                                    <div style={{ marginTop: '0.5rem', paddingTop: '0.5rem', borderTop: '1px solid #e2e8f0' }}>
                                                      ...
                                                      <div style={{
                                                        fontSize: '0.875rem',
                                                        fontWeight: '600',
                                                        color: isStudentAnswerCorrect ? '#16a34a' : '#dc2626',
                                                        display: 'flex',
                                                        alignItems: 'center',
                                                        gap: '0.5rem'
                                                      }}>
