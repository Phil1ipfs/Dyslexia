...
const AdminDashboard = () => {
  ...
  const [students, setStudents] = useState([
    ...
    },
    {
      ...
      grade: "3",
      progress: "92%",
      learningChallenges: ["Reading Comprehension", "Vocabulary"],
      learningStrengths: ["Phonological Awareness", "Word Recognition"],
      recentActivity: {
        description: "Completed 25 vocabulary exercises with 92% accuracy"
      },
      recommendedActivities: [
    ...
    },
    {
      ...
      grade: "1",
      progress: "65%",
      learningChallenges: ["Letter Recognition", "Sound Blending"],
      learningStrengths: ["Visual Memory", "Listening Skills"],
      recentActivity: {
        description: "Completed 20 letter recognition activities with 65% accuracy"
      },
      prescriptiveAnalysis: "Sofia needs more practice with letter sounds and blending. Recommend daily practice with basic phonics."
    },
    {
      id: 6,
      name: "Carlos Mendoza",
      grade: "2",
      progress: "81%",
      learningChallenges: ["Writing Skills", "Spelling"],
      learningStrengths: ["Reading Fluency", "Phonological Awareness"],
      recentActivity: {
        description: "Completed 15 spelling exercises with 81% accuracy"
      },
      recommendedActivities: [
    ...
    },
    {
      ...
      grade: "3",
      progress: "88%",
      learningChallenges: ["Grammar", "Sentence Structure"],
      learningStrengths: ["Vocabulary", "Reading Comprehension"],
      recentActivity: {
        description: "Completed 22 grammar exercises with 88% accuracy"
      },
      recommendedActivities: [
        "Advanced Grammar",
        "Creative Writing"
    ...
    },
    {
      ...
      grade: "1",
      progress: "58%",
      learningChallenges: ["Phonological Awareness", "Attention Span"],
      learningStrengths: ["Visual Pattern Recognition", "Oral Storytelling"],
      recentActivity: {
        description: "Completed 18 attention training exercises with 58% completion"
      },
      prescriptiveAnalysis: "Antonio struggles with maintaining focus during literacy activities. Recommend shorter, more frequent learning sessions with regular breaks."
    },
    {
      id: 9,
